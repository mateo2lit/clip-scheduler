...
const PLATFORMS: { key: string; label: string; color: string; icon: React.ReactNode }[] = [
  ...
  {
    key: "x", label: "X (Twitter)", color: "group-hover:text-white",
    icon: <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.73-8.835L1.254 2.25H8.08l4.259 5.63 5.905-5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
  },
  {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
        <span className="text-sm font-semibold tracking-tight text-white/80">Clip Dash</span>
