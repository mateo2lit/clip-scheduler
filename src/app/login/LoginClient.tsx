      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center justify-center">
            <img src="/logo.svg" alt="Clip Dash" className="h-24 w-auto" />
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
          ...
          {mode !== "forgot" && (
            <div className="mt-6 space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 rounded-full border border-white/10 bg-white/5 px-5 py-3 text-sm font-medium text-white/80 hover:bg-white/10 transition-colors disabled:opacity-60"
              >
          ...
          <form onSubmit={handleSubmit} className={mode !== "forgot" ? "space-y-4" : "mt-6 space-y-4"}>
            <input
              value={email}
