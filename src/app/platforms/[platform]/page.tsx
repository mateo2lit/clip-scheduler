...
const PLATFORM_CONTENT: Record<string, {
  ...
  threads: {
    name: "Threads",
    tagline: "Text & Video for the Open Web",
    color: "from-white/[0.04] via-transparent to-transparent",
    description: "Threads is Meta's fastest-growing platform, launched in 2023 and already surpassing 320 million active users. Built as a conversational companion to Instagram, Threads rewards authenticity and real-time sharing. Its integration with the fediverse (ActivityPub) means your content can reach users on Mastodon and other decentralized platforms.",
    signupUrl: "https://www.threads.net",
    signupLabel: "Create a Threads Account",
    stats: [
      { value: "320M+", label: "monthly active users" },
      { value: "2023", label: "fastest app to reach 100M users ever" },
      { value: "100M+", label: "daily active users" },
      { value: "Fediverse", label: "compatible via ActivityPub" },
    ],
    why: [
      "Threads is in its growth phase — the algorithm is actively rewarding early creators with outsized reach while the platform builds its user base.",
      "Because Threads is tied to Instagram, connecting one Meta account gives you a built-in head start: your Instagram followers can find you immediately on Threads.",
      "Threads rewards conversational, authentic content — it's less polished than Instagram, which means lower production pressure and faster publishing.",
      "The fediverse integration means your Threads posts can eventually be followed by users on Mastodon and other open social networks, extending your reach beyond Meta.",
    ],
    features: [
      { label: "Video Posts", detail: "Short video clips are posted as native Threads media posts visible in your followers' feeds and in the explore tab." },
      { label: "Caption", detail: "The post description is used as the Threads post text, supporting up to 500 characters." },
      { label: "Async Container Flow", detail: "Threads uses the same two-phase container publish flow as Instagram — Clip Dash handles this automatically." },
    ],
    note: "Threads requires a Meta Developer app with threads_basic and threads_content_publish permissions. Connect your Threads account in Settings to get started.",
  },
  bluesky: {
    name: "Bluesky",
    ...
    features: [
      ...
      { label: "Sync Publishing", detail: "Unlike Instagram and Threads, Bluesky posts publish synchronously — no container polling needed." },
    ],
